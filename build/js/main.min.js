...
/*!************************!*\
  !*** ./src/js/main.js ***!
  \************************/
/*! no exports provided */function(t,e,n){"use strict";n.r(e);var r=n(/*! ./myCalendar */"./src/js/myCalendar.js"),a=n(/*! ./render */"./src/js/render.js"),c=n(/*! ./fetch */"./src/js/fetch.js"),i=n(/*! ./renderEvents */"./src/js/renderEvents.js"),o=n(/*! ./popup */"./src/js/popup.js");document.addEventListener("DOMContentLoaded",function(){var t=document.querySelector(".calendar"),e=t.querySelector(".calendar__date"),n=e.querySelector(".calendar__date-text"),u=e.querySelector(".calendar__date-btn--prev"),s=e.querySelector(".calendar__date-btn--next"),h=t.querySelector(".calendar__today"),l=t.querySelector(".calendar__list"),d=function(){Object(a.renderDate)(n,r.default),Object(a.renderCalendar)(l,r.default),Object(c.default)(function(e){var n=t.querySelectorAll(".calendar__item");Object(i.renderEvents)(n,Object(i.findActualEvents)(e,r.default));var a=[].concat(function(t){if(Array.isArray(t)){for(var e=0,n=Array(t.length);e<t.length;e++)n[e]=t[e];return n}return Array.from(t)}(n)).filter(function(t){return t.classList.contains("calendar__item--event")});console.log(a),a&&Object(o.default)(a)})};r.default.changeDateHandler=d,u.addEventListener("click",function(){return r.default.prev()}),s.addEventListener("click",function(){return r.default.next()}),h.addEventListener("click",function(){return r.default.reset()}),d()})},"./src/js/myCalendar.js":
/*!******************************!*\
...
/*!*************************!*\
  !*** ./src/js/popup.js ***!
  \*************************/
/*! exports provided: default */function(t,e,n){"use strict";n.r(e);var r=document.querySelector(".popup-wrapper"),a=r.querySelector(".popup"),c=a.querySelector(".popup__content"),i=a.querySelector(".popup__close"),o=function t(e){var n=e.currentTarget,o=n.querySelector(".event").cloneNode(!0);c.innerHTML="",o.classList.add("event--active"),c.appendChild(o),console.log(a);r.classList.add("popup-wrapper--active"),n.removeEventListener("click",t),i.addEventListener("click",function e(){r.classList.remove("popup-wrapper--active"),i.removeEventListener("click",e),n.addEventListener("click",t)})};e.default=function(t){if(document.body.clientWidth>900)return!1;[].concat(function(t){if(Array.isArray(t)){for(var e=0,n=Array(t.length);e<t.length;e++)n[e]=t[e];return n}return Array.from(t)}(t)).forEach(function(t){t.addEventListener("click",o)})}},"./src/js/render.js":
/*!**************************!*\
  !*** ./src/js/render.js ***!
  \**************************/
/*! exports provided: renderDate, renderCalendar */function(t,e,n){"use strict";n.r(e),n.d(e,"renderDate",function(){return c}),n.d(e,"renderCalendar",function(){return i});var r=[{long:"Понедельник",short:"ПН"},{long:"Вторник",short:"ВТ"},{long:"Среда",short:"СР"},{long:"Четверг",short:"ЧТ"},{long:"Пятница",short:"ПТ"},{long:"Суббота",short:"СБ"},{long:"Воскресенье",short:"ВС"}],a=["Январь","Февраль","Март","Апрель","Май","Июнь","Июль","Август","Сентябрь","Октябрь","Ноябрь","Декабрь"],c=function(t,e){t.textContent=a[e.month]+" "+e.year},i=function(t,e){for(var n=e.firstWeakDay,a=e.lastWeakDay,c=e.isCurrentMonth,i=e.todayDate,h=e.prevMonthDays,l=1,d=document.createDocumentFragment(),f=n-1;f>=1;f--){var y=r[f-1].long+", "+h;o(d,["calendar__item","calendar__item--inactive"],y,!1),h--}for(var v=1;v<=e.days;v++){var p=c&&i===v?["calendar__item","calendar__item--active"]:["calendar__item"],m=n+v-1<=7?r[n+v-2].long+", "+v:v;o(d,p,m)}for(var g=a+1;g<=7;g++){o(d,["calendar__item","calendar__item--inactive"],l),l++}t.innerHTML="",t.appendChild(d);var M=t.querySelectorAll(".calendar__item");M.forEach(function(t){return u(t)}),window.addEventListener("resize",function(){return s(M)})},o=function(t,e,n){var r,a=!(arguments.length>3&&void 0!==arguments[3])||arguments[3],c=document.createElement("li"),i=document.createElement("span");(r=c.classList).add.apply(r,function(t){if(Array.isArray(t)){for(var e=0,n=Array(t.length);e<t.length;e++)n[e]=t[e];return n}return Array.from(t)}(e)),c.setAttribute("tabindex",0),i.classList.add("calendar__item-date"),i.textContent=n,c.appendChild(i),a?t.appendChild(c):t.prepend(c)},u=function(t){t.style.height=t.offsetWidth+"px"},s=function(t){t.forEach(function(t){return u(t)})}},"./src/js/renderEvents.js":
/*!********************************!*\
